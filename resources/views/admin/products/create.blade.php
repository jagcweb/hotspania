<div class="modal fade" id="create-product" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <form method="POST" action="{{route('admin.product.create')}}" enctype='multipart/form-data'>
                    ...
                    <div class="form-group subcategory_div d-none">
                        ...
                        <select class="form-control subcategory" name="subcategory">
                            <option disabled selected hidden>Selecciona una categoría para cargar las subcategorias...</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required placeholder="Diavla Mini">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" step="0.01" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" required placeholder="15.50">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" class="form-control @error('units') is-invalid @enderror" name="units" value="{{ old('units') }}" required placeholder="120">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" class="form-control @error('discontinued') is-invalid @enderror" name="discontinued" value="1">
